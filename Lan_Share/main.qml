...
ApplicationWindow {
    ...
    visible: true
    width: 400
    height: 700 // Трохи вище для сучасних смартфонів
    title: "Lan Share Mobile"

    // --- НАЛАШТУВАННЯ КОЛЬОРІВ ---
    readonly property color primaryColor: "#2196F3"    // Основний синій
    readonly property color accentColor: "#1976D2"     // Темніший синій для натискань
    readonly property color bgColor: "#F5F7FA"         // Світло-сірий фон
    readonly property color cardColor: "#FFFFFF"       // Білий для карток
    readonly property color textColor: "#263238"       // Темно-сірий для тексту
    readonly property color subTextColor: "#78909C"    // Світло-сірий для описів
    ...
    Popup {
        ...
        ColumnLayout {
            ...
            Button {
                ...
                Layout.alignment: Qt.AlignHCenter
                onClicked: {
                    // Тут можна додати логіку скасування в майбутньому
                    transferPopup.close()
                }
            }
        }
    ...
    Connections {
        ...
        function onTransferFinished(success, message) {
            transferPopup.close(); // Закриваємо вікно прогресу
            progressBar.value = 0;
